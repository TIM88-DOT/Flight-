...
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://tripadvisor1.p.rapidapi.com/flights/create-session?dd2=&currency=GBP&ta=$adults&c=0&d1=$destination&o1=$origin&dd1=2020-06-29",
            ...
            <header id="header" class="header-v1">
                ...
                <nav class="flat-mega-menu">            
                    ...
                    <ul class="collapse"><!-- collapse class for collapse the drop down -->
                        ...
                        <li class="title">
                            <a href="{{url('/')}}"><span>T</span>ravelia<span>.</span></a> 
